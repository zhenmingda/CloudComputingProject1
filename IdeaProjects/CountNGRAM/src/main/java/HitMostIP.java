...
public class HitMostIP {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setMapperClass(HitMostIP.TokenizerMapper.class);
        job.setCombinerClass(HitMostIP.IntSumReducer.class);
        job.setReducerClass(HitMostIP.IntSumReducer.class);
