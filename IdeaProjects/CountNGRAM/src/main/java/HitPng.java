...
public class HitPng {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "Hit Png");

        job.setJarByClass(HitPng.class);
        job.setMapperClass(HitPng.TokenizerMapper.class);
        job.setCombinerClass(HitPng.IntSumReducer.class);
        job.setReducerClass(HitPng.IntSumReducer.class);
